...
class BottleOfWineDemo implements ActionListener
  {
   JLabel displayLabel;
   JButton nextButton;
   JButton prevButton;
   ...
   ResourceBundle bottleOfWineResources;
   ...
   BottleOfWineDemo()
     {
      try
        {
         bottleOfWineResources = ResourceBundle.getBundle("resources.BottleOfWineResources",Locale.getDefault());
        }
      ...
      JFrame jfrm = new JFrame(bottleOfWineResources.getString("BottleOfWineDemo"));
      ...
      prevButton = new JButton(bottleOfWineResources.getString("Prev"));
      prevButton.setActionCommand("Prev");
      buttonPanel.add(prevButton);
      prevButton.addActionListener(this);

      nextButton = new JButton(bottleOfWineResources.getString("Next"));
      ...
      /*========================*/
      /* Load the BottleOfWine program. */
      /*========================*/

      clips = new Environment();

      clips.load("bottleOfWinedemo.clp");
   ...
   private void nextUIState() throws Exception
     {
      ...
      if (fv.getFactSlot("state").toString().equals("final"))
        {
         ...
         nextButton.setText(bottleOfWineResources.getString("Restart"));
         prevButton.setVisible(true);
        }
      else if (fv.getFactSlot("state").toString().equals("initial"))
        {
         nextButton.setActionCommand("Next");
         nextButton.setText(bottleOfWineResources.getString("Next"));
      ...
      for (int i = 0; i < pv.size(); i++)
        {
         ...
         if (bv.toString().equals(selected))
            { rButton = new JRadioButton(bottleOfWineResources.getString(bv.toString()),true); }
         else
            { rButton = new JRadioButton(bottleOfWineResources.getString(bv.toString()),false); }
      ...
      String theText = bottleOfWineResources.getString(fv.getFactSlot("display").symbolValue());
   ...
   public static void main(String args[])
     {
      ...
      SwingUtilities.invokeLater(
        new Runnable()
          {
           public void run() { new BottleOfWineDemo(); }
          });
     }
  }
